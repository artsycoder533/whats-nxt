...
const Hero = () => {
  return (
    <section className="flex h-[90vh] flex-col justify-center gap-12 relative">
      ...
      <div className="z-10 text-white flex flex-col justify-center max-w-[1400px] w-[90vw] mx-auto pt-8 md:pt-16">
        <h1 className="text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl flex flex-col gap-1 font-extralight">
