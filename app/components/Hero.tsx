...
const Hero = () => {
  return (
    <section className="flex h-[70vh] flex-col justify-center  gap-12 relative">
      {/* Video Background */}
      ...
      <div className="z-10 text-white flex flex-col max-w-[1400px] w-[90vw] mx-auto">
        <h1 className="text-7xl flex flex-col gap-1 font-extralight">
          <span className="flex gap-2">Imagine</span>
          <HiArrowDown className="text-[#B76E79] my-2"/>
        ...
        <Link
          href="/products"
          className="animate-bounce py-3 px-4 bg-[#B76E79] text-white text-center mt-32 self-center rounded-md hover:bg-[#8a525a]"
        >
          Shop WHATS NXT
        </Link>
      </div>
